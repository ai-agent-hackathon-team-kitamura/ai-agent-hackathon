            ...
            <Box mb={8}>
                ...
                {activeTab === 'year-month' && (
                    <Box>
                        ...
                        {/* Date Selectors and Chart - Combined */}
                        <Box position="relative" mb={8} borderRadius="xl" overflow="hidden">
                            <Box
                                filter="blur(4px)"
                                pointerEvents="none"
                                p={6}
                            ...
                            <Box
                                ...
                                right="0"
                                bottom="0"
                                bg="radial-gradient(ellipse at center, rgba(0,0,0,0.1) 30%, rgba(0,0,0,0.1) 70%, rgba(0,0,0,0.1) 100%)"
                                borderRadius="xl"
                                zIndex={5}
                            />
