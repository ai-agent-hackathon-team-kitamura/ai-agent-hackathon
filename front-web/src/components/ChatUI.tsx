...
const ChatUI: React.FC = () => {
  ...
  const { messages, isInitialLoading, handleSendMessage: sendMessage, isLoading, error, isError } = useChatMessages();
  ...
  return (
    <Flex direction="column" height="calc(100vh - 150px)" justify="space-between">
      <ScrollableMessageList messages={messages} isInitialLoading={isInitialLoading} messagesEndRef={messagesEndRef} />
